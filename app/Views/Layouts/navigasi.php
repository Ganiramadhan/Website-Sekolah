      ...
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link  <?php if ($tittle == 'Home') {
                                echo 'active';
                              } ?>" href="<?= base_url('/siakad/home') ?>"><i class="fa-solid fa-house-user"></i> Home</a>
        </li>

        <li class="nav-item">
          <a class="nav-link  <?php if ($tittle == 'Mahasiswa') {
                                echo 'active';
                              } ?>" href="<?= base_url('/') ?>"><i class="fa-solid fa-user-tie"></i> Mahasiswa</a>
        </li>

        <li class="nav-item">
          <a class="nav-link  <?php if ($tittle == 'Nilai') {
                                echo 'active';
                              } ?>" href="<?= base_url('/siakad/nilai') ?>"><i class="fa-solid fa-user-graduate"></i> Nilai</a>
        </li>
